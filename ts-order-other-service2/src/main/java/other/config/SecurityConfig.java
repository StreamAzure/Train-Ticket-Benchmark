...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    String admin = "ADMIN";
    String orderOther = "/api/v1/orderOtherService2/orderOther";
    /**
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.httpBasic().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/api/v1/orderOtherService2/orderOther/**").permitAll()
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/orderOtherService2/orderOther/admin").hasAnyRole(admin)
                .antMatchers(HttpMethod.PUT, "/api/v1/orderOtherService2/orderOther/admin").hasAnyRole(admin)
